...
public class Game_old {
	...
	public Game_old(String p1, String p2, int width, int height, int win, int time, int expire, Location top, Location btm) {
	...
	public Game_old(int width, int height, int win, int time, int expire, Location top, Location btm) {
